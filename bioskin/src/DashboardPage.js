          ...
          <div className="stat-cards-grid">
            ...
            <div className="card stat-card">
              ...
              <div className="stat-info">
                ...
                <p>today's sales <em style={{fontSize:'0.8em', color:'var(--color-text-light)'}}>(Simulated)</em></p>
              </div>
            </div>
            {/* New Orders */}
            <div className="card stat-card">
              ...
              <div className="stat-info">
                ...
                <p>new orders <em style={{fontSize:'0.8em', color:'var(--color-text-light)'}}>(Simulated)</em></p>
              </div>
            </div>
            {/* Low Stock */}
            <div className="card stat-card">
